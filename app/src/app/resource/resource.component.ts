...
import {
    ApiServiceError, ApiServiceResult, ConvertJSONLD,
    ImageRegion, IncomingService,
    KnoraConstants, OntologyCacheService, OntologyInformation,
    ReadLinkValue,
    ReadPropertyItem,
    ReadResource, ReadResourcesSequence, ReadStillImageFileValue,
    ResourceService,
...
export class ResourceComponent implements OnInit {
    ...
    ngOnInit() {
        this._route.params.subscribe((params: Params) => {
            this.id = params['iri'];
            this.getResource(decodeURIComponent(this.id));
        });
    }
    ...
    private collectImagesAndRegionsForResource(resource: ReadResource): void {
        ...
        if (resource.properties[KnoraConstants.hasStillImageFileValue] !== undefined) {
            ...
            for (const img of imagesToDisplay) {
                ...
                console.log(imgRepresentations);
